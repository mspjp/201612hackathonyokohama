...
Botの上にあるテキストボックスの各項目を埋めます。

- **Local Port** :9000
- **Emulator Url** :http://localhost:9000/
- **Bot Url** :http://localhost:3979/api/Messages
...
画像データの場合、**コピペゾーン2**に主にコピペすることになります。
...
**重要:画像ファイルの使用はslackかWebChatでしか使用できません**
